...
enum ApiTypes{
    ...
    case followUnfollow(parameter:Parameter?)
...
extension ApiTypes : EndPointType {
    ...
    var task: HTTPTask {
        switch self {
        case .LoginUser, .SignUp, .VerifyOtp, .UpdateProfile, .Forget_Password, .ResendOTP, .SetNew_Password, .createPost,.myEvents, .createEvent, .postlist, .postLikeList, .postCommentList, .userProfile, .userProfileDetail, .followUnfollow, .likeUnlikePost, .storePostComment, .uploadprofileimage, .storeUserIntrest, .getAllUserList:
